...
class AeSession extends AeNode_Nested
{
    ...
    protected function _start()
    {
        ...
        if (!$this->get('time.start', false)->value) {
            $start = time();
    ...
    protected function _validate()
    {
        ...
        if ($this->_lifetime)
        {
            $curTime = (int) $this->get('time.now', 0)->value;
            $maxTime = (int) $this->get('time.last', 0)->value + $this->_lifetime;
    ...
    protected function _setOptions(AeArray $options)
    {
        ...
        if (isset($options['lifetime'])) {
            $this->_lifetime = (int) $options['lifetime']->toInteger()->value;
        } else {
        ...
        $expire = isset($options['expire']) ? $options['expire']->toBoolean()->getValue() : false;
        $args   = array();

        $args[] = $expire ? 0 : $this->_lifetime;
